...
<html>
  ...
  <hr>
  <form method="post" name="simulation_from" action="<?=$_SERVER['PHP_SELF']?>">
                          ...
                          <td>
                            ...
                            <table width=100% border=0 bgcolor='#c2c2c2' cellspacing=1 cellpadding=5>
                              ...
                              <tr bgcolor=FFFFFF>
                                <td height=20></td>
                                <td></td>
                                <td colspan=2 align=right><font color=#FF3300><b>消費總金額　349</b></font></td>
                              </tr>
                            </table>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                              <tr>
    ...
    <input type="hidden" name="su_id"  value="hsu6028@gmail.com"> <!-- 業主在 ezShip 使用的帳號 -->
    <input type="hidden" name="rv_amount" value="1000"><!-- 金額 -->
    <input type="hidden" name="webtemp" value="simulationpage"><!-- 網站所需額外判別資料。ezShip 將原值回傳，供網站判別用 -->
    <input type="hidden" name="rturl" value="http://test.lifebooks.com.tw/test/OrderStatus.php"><!-- 回傳路徑及程式名稱 -->
  </form>
  <hr>
  </body>
</html>
