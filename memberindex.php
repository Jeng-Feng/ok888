...
<? require_once($config['global_library'].'/_top_memberindex.php'); ?>
<!DOCTYPE html>
...
<!-- InstanceBeginEditable name="custom javascript" -->
  <? require_once($config['global_library'].'/_memberindex.php'); ?>
  <style>
  .box-middle {
    overflow: hidden;
  }
...
<div id="bootstrap_content">
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-3">
        <article> <img src="./images/pages/memberindex-01.png" alt="" class="img-responsive">
          <div class="boxContent color1">
            <h3>訂單查詢</h3>
            <p>查詢您的訂單狀況</p><br>
            <a class="btn btn-medium btn-primary" href="./orderhistory.php">查詢</a>
          </div>
        </article>
      </div>
      ...
      <div class="col-sm-3">
        <article> <img src="./images/pages/memberindex-02.png" alt="" class="img-responsive">
          <div class="boxContent color1">
            <h3>製作紀錄</h3>
            <p>管理您的製作(分享,複製,刪除,修改)</p><br>
            <a class="btn btn-medium btn-primary" href="./booklists.php">管理</a>
          </div>
        </article>
      </div>
      ...
      <div class="col-sm-3">
        <article> <img src="./images/pages/memberindex-03.png" alt="" class="img-responsive">
          <div class="boxContent color1">
            <h3>會員資料</h3>
            <p>修改您的聯絡方式</p><br>
            <a class="btn btn-medium btn-primary" href="./membermodify.php">修改</a>
          </div>
        </article>
      </div>
      
      <? if($privilege_onlinephoto ==1): ?>
      <div class="col-sm-3">
        <article><img src="./images/pages/memberindex-04.png" alt="" class="img-responsive">
          <div class="boxContent color1">
            <h3><?=$onlinephoto_title?></h3>
            <p>個人專屬免費<?=$onlinephoto_title?></p><br>
            <a class="btn btn-medium btn-primary" href="./album.php">管理</a>
          </div>
        </article>
      </div>
      <? endif;?>
...
<!--
        <div class="col-md-3 col-sm-6 booklist featured-box member-border">
            <div class="booklist-header"><h4><br>訂單查詢</h4><p class="booklist-description small">查詢您的訂單狀況</p></div>
              <div class="box-middle">
                  <img class="center-block img-responsive img-rounded" src="./images/pages/orderhistory.jpg" />
              </div>
            <div class="booklist-footer"><a class="btn btn-medium btn-primary" href="./orderhistory.php">查詢</a></div>
        </div>
        <div class="col-md-3 col-sm-6 booklist featured-box member-border">
            <div class="booklist-header"><h4><br>製作紀錄</h4><p class="booklist-description small">管理您的製作(分享,複製,刪除,修改)</p><br></div>
              <div class="box-middle">
                  <img class="center-block img-responsive img-rounded" src="./images/pages/portfolio.jpg" />
              </div>
            <div class="booklist-footer"><a class="btn btn-medium btn-primary" href="./booklists.php">管理</a></div>
        </div>
        <div class="clearfix visible-sm visible-xs"></div>
        <div class="col-md-3 col-sm-6 booklist featured-box member-border">
            <div class="booklist-header"><h4><br>會員資料</h4><p class="booklist-description small">修改您的聯絡方式</p></div>
              <div class="box-middle">
                  <img class="center-block img-responsive img-rounded" src="./images/pages/membermodify.jpg" />
              </div>
            <div class="booklist-footer"><a class="btn btn-medium btn-primary" href="./membermodify.php">修改</a></div>
        </div>
<? if($privilege_onlinephoto ==1): ?>
<div class="col-md-3 col-sm-6 booklist featured-box member-border">
  <div class="booklist-header"><h4><br><?=$onlinephoto_title?></h4><p class="booklist-description small">個人專屬免費<?=$onlinephoto_title?></p></div>
  <div class="box-middle">
    <img class="center-block img-responsive img-rounded" src="./images/pages/album.jpg" />
  </div>
  <div class="booklist-footer"><a class="btn btn-medium btn-primary" href="./album.php">管理</a></div>
</div>
<? endif;?>
</div>
</div>
