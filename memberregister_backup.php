					...
					<div class="php-memberregister">
						...
						<form class="form-horizontal" action="new_member_do.php" method="post" name="FileHeaderForm" id="FileHeaderForm">
						  ...
						  <div class="form-group">
								...
								<div class="col-sm-3">
									<select name="city" id="city" onchange="javascript:citychange();putzip();" class="form-control select" tabindex="7" style="margin-bottom:5px;">
									...
									<label for="inpubktitle3" class="col-lg-2 control-label">郵遞區號：</label>
								<div class="col-lg-2">
									<input name="Zipcode" id="Zipcode" class="form-control" type="text" size="5" value="" />
								</div>
									<div class="col-md-10 col-md-offset-2">
										<input class="form-control" name="memberAdd3" id="memberAdd3" type="text" tabindex="9" />
									</div>
								</div>
						  </div>
						  <div class="form-group">
