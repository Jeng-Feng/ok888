  ...
  <div class="container">
    <div class="row">
      ...
      <aside id="sidebar" class="col-md-3">
        <nav id="subnav">
          <ul>
            ...
            <li><a class="active" href="faq05.php">出貨與售服<i class=" icon-right-open-mini"></i></a></li>
          </ul>
        </nav>
      </aside>
      <!-- end sidebar -->
      ...
      <section class="col-md-9">
        ...
        <div class="row mb15">
          <div class="col-md-12">
            <h2>Q1：訂單送出後，多久可以收到相片書、無框裝飾畫？</h2>
            <p> A：訂單送出後，<span>經本公司會計部確認款項後，才會開始製作，工作日約7~10天（不含六、日）將可完成</span>，例假日或國定假日則順延交件日期。<br>
          若您選購直A4水晶封面相片書（組）、典藏回憶本(蝴蝶書)、19吋大婚紗本(蝴蝶書)等產品，工作日約8~10天；19吋水晶封面相片書（組），工作日約10~12天。</p>
        </div>
      </div>
      <div class="row mb15">
        <div class="col-md-12">
          <h2>Q2：出貨（可取貨）時，會電話／簡訊通知嗎？</h2>
          <p>A：出貨或可取貨時，本公司<span> 會以簡訊通知</span>。<br>
          您在<span> 會員登入→購物清單→狀態</span> 若顯示「可取貨／已交付物流」，表示您很快就能拿到作品了。</p>
        </div>
        <div class="col-md-12"> <img src="images/faq-details/newbie_ok.jpg" alt="已交付物流" class="img-responsive"> </div>
      </div>
      <div class="row mb15">
        <div class="col-md-12">
          <h2>Q3：收到的成品有瑕疵，該如何處理？</h2>
          <p>A：所有要辦理換貨的客戶，請將以下資料送至品管信箱<br>
            <a href="mailto:101@mail.ok888.com.tw">101@mail.ok888.com.tw</a><br>
            1. 原訂單號碼。<br>
            2. 作品名稱。<br>
            3. 姓名及白天連絡電話、E-mail帳號等資訊。<br>
            4. 商品瑕疵情形的照片。<br>
            其他詳細說明請參閱 <a href="sendback.php">退換貨政策</a> 文件內容。</p>
          </div>
        </div>
      </section>
