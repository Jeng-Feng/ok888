      ...
      <div id="bootstrap_content">
        <div class="container pt40 pb40">
          <div class="product-step1">
            <div class="row">
              <div class="col-sm-8"> <img class="img-responsive center-block"  src="/images/step1_title.png" alt="請選擇產品"/> </div>
            </div>
          </div>
        </div>
        <?php
...
?>
        <div class="container"> 
          ...
          <div class="container pt40 pb40">
            <div class="product-step1">
              <div class="row">
                <div class="col-sm-8"> <img id="php_step2" class="img-responsive hidden" src="<?=$config["url"]?>/images/step2_title.png" alt="<?=$lang_PlsChooseTemplateclass?>" /> </div>
              </div>
            </div>
          </div>
          <br />
          ...
          <div class="row keyininfor" style="display:none">
            <div class="container pt40 pb40">
              <div class="product-step1">
                <div class="row">
                  <div class="col-sm-8"> <img class="img-responsive center-block"  src="/images/step3_title.png" alt=" 開始"/> </div>
                </div>
              </div>
            </div>
            <br/>
