<?php 
	...
	require_once($config['global_library'].'/_top_verifyedit.php');
?>
<!DOCTYPE html>
...
<?require_once($config['global_library'].'/_verifyedit.php');?>
				...
				<div class="container" align="center">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">您要編輯 or 訂購 <span id="bkname"></span>?</h3>
						</div>
						<div class="panel-body php-verifyedit">
							
							<h6 class="text-left step1subtitle">
								<img src="/images/im/flag.gif" width="13" height="13" alt="*" class="step1subtitle-img">
								<span class="step1subtitle-text">作品編號:</span>
								<span id="bookid"></span>
							</h6>
							<div>
								<div id="status" align="center"><?=$errst?></div>
								<div id="verid">
									<form id="form1" name="form1" method="post" action="verifyedit.php" class="form-horizontal">
										<div class="form-group">
											<label for="veripassword" class="col-sm-2 control-label">請輸入編輯密碼:</label>
											<div class="col-sm-10">
												<input type="text" class="form-control" name="veripassword" id="veripassword" value='' maxlength="10" />
											</div>
										</div>
										<div class="form-group">
											<label for="verirobat" class="col-sm-2 control-label">請輸入驗證碼:</label>
											<div class="col-sm-10">
												<div class="row">
													<div class="col-sm-10">
														<input type="text" class="form-control" name="verirobat" id="verirobat" value='' maxlength="10" /><br />
													</div>
													<div class="col-sm-2">
														<img src="./showrandimg.php" id="rand-img" style="vertical-align:middle;margin-bottom:-14px;" border="0"><a href="javascript:void(0);" id="reload-img" style="font-size:12px;"><img src="./images/refresh.gif" title="重新產生驗證碼"  style="vertical-align:middle;margin-left:10px;margin-bottom:-14px;" border="0"/></a>
													</div>
												</div>
											</div>
										</div>
										<div class="form-group normal-button-holder">
											<div class="col-sm-12 text-center">
												<a id="verfibt" class="btn btn-primary" href="javascript:verifypp();"><span>確定</span></a>
											</div>
										</div>
									</form>
								</div>
