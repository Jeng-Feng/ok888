					...
					<nav class="navbar navbar-default scrollMenu" role="navigation">
						...
						<div class="collapse navbar-collapse" id="mainMenu">
							...
							<ul class="nav navbar-nav pull-right">
								...
								<li class="primary">
									<a href="index.html" class="firstLevel hasSubMenu" >Home</a>
									<ul class="subMenu">
											...
											<div class="row">
												<div class="col-sm-4">
													...
													<div class="megaInner">
														...
														<img alt="" src="images/theme-pics/pic-mega-menu.png" class="img-responsive">
													</div>
								...
								<li class="primary">
									<a href="portfolio-masonery.html" class="firstLevel active hasSubMenu">Portfolio</a>
									<ul class="subMenu">
					...
					<div class="row">
						...
						<div class="col-sm-6 hidden-xs">
							<ul id="navTrail">
								...
								<li id="navTrailLast">Portfolio 3 columns</li>
							</ul>
						</div>
					</div>
				</div>
