...
<? require_once($config['global_library'].'/_top_products.postcard.php'); ?>
<!DOCTYPE html>
...
<? require_once($config['global_library'].'/_products.postcard.php'); ?>
...
?>
	...
	<div class="container">
		...
		<? endforeach; ?>
			<!--一般明信片-->
			<div id="input_postcard" class="row keyininfor" style="display:none">
				...
				<div class="col-md-6 kipreview">		
					
				</div>
			</div>
			
			<!--代寄明信片-->
			<div id="input_postcard_b" class="row keyininfor" style="display:none">
				<img class="img-responsive" src="/images/step3_title.png" alt="我們要開始囉"/>
				<br/>
				<div id="input_postcard_b_inner" class="col-md-12">
					<form class="form-horizontal" role="form"  method="post" name="gotoeditor" id="gotoeditor">
						<input type="hidden" name="bktemplate" id="bktemplate" />
						<input type="hidden" name="action" id="action" value="beforeedit" />
						
					  <div class="form-group">
						<label for="inpubktitle3" class="col-sm-4 control-label"><?=$lang_bkname?></label>
						<div class="col-sm-8">
						  <input type="text" class="form-control" id="bkname" name="bkname" placeholder="pleas input title" maxlength="24">
						</div>
					  </div>
					  
					  <div class="form-group">
						<label for="inpubktitle3" class="col-sm-4 control-label"><?=$lang_province?></label>
						<div class="col-sm-8">
							<div class="row">
								<div class="col-md-3 col-sm-3 col-xs-3">
									<select class="form-control" name="province" id="province" onchange="javascript:province_onchange('from');"></select>
								</div>	
								<div class="col-md-3 col-sm-3 col-xs-3">
									<select class="form-control" name="zone" id="zone" onchange="javascript:zone_onchange('from');"></select>
								</div>	
								<div class="col-md-3 col-sm-3 col-xs-3">
									<input class="form-control" id="deliveryZIP" name="deliveryZIP" type="text" maxlength="5" placeholder="<?=$lang_deliveryZIP?>"/>
								</div>
							</div>
						</div>
					  </div>
					  ...
					  <div class="form-group">
						<label for="inpubktitle3" class="col-sm-4 control-label"></label>
						<div class="col-sm-8">
							<input class="form-control" type="text" id="delveryadd" name="delveryadd" />
						</div>
					  </div>
					  
					  
					   <div class="form-group">
						<label for="inpubktitle3" class="col-sm-4 control-label"><?=$lang_bkname_sender?></label>
						<div class="col-sm-8">
						  <input type="text" class="form-control" id="bkname_sender" name="bkname_sender" placeholder="pleas input title" maxlength="24">
						</div>
					  </div>
					  
					  <div class="form-group">
						<label for="inpubktitle3" class="col-sm-4 control-label"><?=$lang_province_sender?></label>
						<div class="col-sm-8">
							<div class="row">
								<div class="col-md-3 col-sm-3 col-xs-3">
									<select class="form-control" name="province_sender" id="province_sender" onchange="javascript:province_onchange('sender');"></select>
								</div>	
								<div class="col-md-3 col-sm-3 col-xs-3">
									<select class="form-control" name="zone_sender" id="zone_sender" onchange="javascript:zone_onchange('sender');"></select>
								</div>	
								<div class="col-md-3 col-sm-3 col-xs-3">
									<input class="form-control" id="deliveryZIP_sender" name="deliveryZIP_sender" type="text" maxlength="5" placeholder="<?=$lang_deliveryZIP_sender?>"/>
								</div>
							</div>
						</div>
					  </div>
					  ...
					  <div class="form-group">
						<label for="inpubktitle3" class="col-sm-4 control-label"></label>
						<div class="col-sm-8">
							<input class="form-control" type="text" id="delveryadd_sender" name="delveryadd_sender" />
						</div>
					  </div>
