...
<? require_once($config['global_library'].'/_top_getPassword_resetpassword.php'); ?>
<!DOCTYPE html>
...
<? require_once($config['global_library'].'/_getPassword_resetpassword.php'); ?>
<!-- InstanceEndEditable -->
		...
		<div id="bootstrap_content">
			<div class="container" align="center">
				...
				<div class="form-group col-md-12">
					<span class="col-md-3 text-right">密碼驗證碼：</span>
					<div class="col-md-3">
						<input id="vercode" class="form-control" name="vercode" type="text" value="<?=$vercode?>" size="10" onchange="vercodecheck();" placeholder="請在此輸入密碼驗證碼"/>
					</div>
					<div id="msg" class="col-md-4 text-left"></div>
				</div>
				<div class="col-md-12">
					<form class="form-horizontal" role="form" action="" method="post" name="form" id="form">
						<div class="form-group changepw_ok">
							<label for="inpubktitle3" class="col-md-3 control-label">請輸入新密碼：</label>
							<div class="col-md-9">
								<input id="newpassword" class="form-control" name="newpassword" type="password" size="30" placeholder="請在此輸入您的新密碼"/>
							</div>
						</div>
						<div class="form-group changepw_ok">
							<label for="inpubktitle3" class="col-md-3 control-label">請再輸入一次新密碼：</label>
							<div class="col-md-9">
								<input id="newpasswordagain" class="form-control" name="newpasswordagain" type="password" size="30" placeholder="請在此輸入您的新密碼"/>
							</div>
						</div>
						<div class="changepw_ok">
							<input type="button" value="確認送出" class="btn btn-primary" onclick="checknewpassword();" />
							<input type="hidden" id="vercodecheck" name="vercodecheck" type="text" value="0" />
						</div>
					</form>
				</div>
			</div>
