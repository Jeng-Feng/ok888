      ...
      <div class="container">
        <nav class="navbar navbar-default scrollMenu" role="navigation">
          <div class="navbar-header"> 
            ...
            <!-- Logo --> 
            <a class="navbar-brand" href="../../index.php"><img src="../home/main-logo.png" alt="photobook logo"/></a> 
...
<div id="bootstrap_content" class="margin-top">
  ...
  <section id="content" class="container">
     <h1 class="text-center">加購商品區</h1>
    <section class="pt30 pb30">
      <div class="container clearfix">
        <div class="row">
          <div class="portfolio-items  isotopeWrapper clearfix " id="3">
            <article class="col-sm-4 isotopeItem women"  id="products1">
              <div class="pinBox"> 
                <figure>
                  <a href="http://test.lifebooks.com.tw/photobookbox.php"> <img class="img-responsive" src="http://test.lifebooks.com.tw/images/products/samplepicture.png" alt="相片錦盒組" /></a>
                </figure>
                <section class="boxContent">
                  <h3><a href="http://test.lifebooks.com.tw/photobookbox.php"><strong>相片錦盒組</strong></a></h3>
                  <p> <a href="http://test.lifebooks.com.tw/photobookbox.php">手工精製，呵護憶念</p>
                </section>
                
              </div>
            </article>
            <article class="col-sm-4 isotopeItem women"  id="products2">
              <div class="pinBox"> 
                <figure>
                  <a href="http://test.lifebooks.com.tw/photobookbox.php"> <img class="img-responsive" src="http://test.lifebooks.com.tw/images/products/iamapicture.png" alt="" /></a>
                </figure>
                <section class="boxContent">
                  <h3><a href="http://test.lifebooks.com.tw/photobookbox.php"><strong>商品名</strong></a></h3>
                  <p> <a href="http://test.lifebooks.com.tw/photobookbox.php">手工精製，呵護憶念</p>
                </section>
                
              </div>
            </article>
            <article class="col-sm-4 isotopeItem women"  id="products3">
              <div class="pinBox"> 
                <figure>
                  <a href="http://test.lifebooks.com.tw/photobookbox.php"> <img class="img-responsive" src="http://test.lifebooks.com.tw/images/products/iamapicture.png" alt="" /></a>
                </figure>
            ...
            <article class="col-sm-4 isotopeItem women"  id="products4">
              <div class="pinBox"> 
                <figure>
                  <a href="http://test.lifebooks.com.tw/photobookbox.php"> <img class="img-responsive" src="http://test.lifebooks.com.tw/images/products/iamapicture.png" alt="" /></a>
                </figure>
            ...
            <article class="col-sm-4 isotopeItem women"  id="products5">
              <div class="pinBox"> 
                <figure>
                  <a href="http://test.lifebooks.com.tw/photobookbox.php"> <img class="img-responsive" src="http://test.lifebooks.com.tw/images/products/iamapicture.png" alt="" /></a>
                </figure>
            ...
            <article class="col-sm-4 isotopeItem women"  id="products6">
              <div class="pinBox"> 
                <figure>
                  <a href="http://test.lifebooks.com.tw/photobookbox.php"> <img class="img-responsive" src="http://test.lifebooks.com.tw/images/products/iamapicture.png" alt="" /></a>
                </figure>
  ...
  <footer id="footerWrapper" class="margin-top">
    <section id="mainFooter">
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <div class="footerWidget"> <img src="../home/main-logo.png" alt="latest Little Neko news" id="footerLogo">
