      ...
      <div class="container clearfix">
        <div class="row">
          <div class="portfolio-items  isotopeWrapper clearfix " id="3">
            ...
            <article class="col-sm-4 isotopeItem women"  id="products">
              <div class="pinBox">
                <figure>
                  <a href="<?=$data['link_url']?>"> <img class="img-responsive" src="<?=$data['thumbnail_url']?>" alt="<?=$data["name"]?>" /></a>
                </figure>
                <section class="boxContent">
                  <h3><a href="<?=$data['link_url']?>"><strong><?=$data['name']?></strong></a></h3>
                  <p> <a href="<?=$data['link_url']?>"><?=$data['describe']?></p>
                </section>
            ...
            <article class="col-sm-4 isotopeItem women"  id="products1">
                  <div class="pinBox">
                    ...
                    <figure>
                    <a href="http://test.lifebooks.com.tw/"> <img class="img-responsive" src="http://test.lifebooks.com.tw/images/products/introduction_box01.png" alt="相片書錦盒組" /></a>
                    </figure>

                    <section class="boxContent">
                      <h3><a href="http://test.lifebooks.com.tw/"><strong>相片書錦盒組</strong></a></h3>
                      <p> <a href="http://test.lifebooks.com.tw/">手工精製，呵護憶念</p>
                    </section>
