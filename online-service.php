...
<!-- InstanceBeginEditable name="custom javascript" -->
    ...
    (function(){
      ...
      c.src = ("https:" == document.location.protocol ? "https" : "http") + "://26.cami.yesing.com/patrol/static_v2/department/image/lifebooks_tw";
    ...
    <div class="container">
      <div class="row">
        <div class="span12 text-center mb40">
          <h1>線上客服</h1>
          <h2 class="subTitle">服務時間: 一~五 / 9:00-22:00<br>
          六 / 9:00-18:00<br>
          (12:00-13:00 午休)</h2>
        </div>
        <div class="col-md-12">
          <div class="color2 ctaBox ">
            <div class="row">
              <div class="col-md-8">
                <h1> <strong>線上客服</strong>
                </h1><br>
                <h3>若離線或忙碌中，請留言，我們會盡快回覆給您。</h3>
