...
<? require_once($config['global_library'].'/_top_memberlogin.php'); ?>
<!DOCTYPE html>
...
<!-- InstanceBeginEditable name="custom javascript" -->
  <? require_once($config['global_library'].'/_memberlogin.php'); ?>
  <!-- InstanceEndEditable -->
</head>
<body>
<!-- Primary Page Layout 
...
<div id="globalWrapper">
  ...
  <section id="page">
    ...
    <div id="bootstrap_content">
      <div class="container">
        <div class="col-md-12">
          <div class="alert alert-danger" style="display:none" id="member_message"></div>
          <form class="form-horizontal" role="form"  method="post" name="php_member_form" id="php_member_form">
            <div class="row">
              <div class="form-group">
                <label for="inpubktitle2" class="col-md-3  control-label text-right">帳號</label>
                <div class="col-md-5">
                  <input name="php_member_account" type="text" class="form-control" id="php_member_account" placeholder="請在此輸入您的帳號">
                  <div class="pull-right">沒有帳號?&nbsp;<a id="php_member_join" href="./memberregisterrule.php">立即註冊</a></div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="form-group">
                <label for="inputbksubtitle3" class="col-md-3 control-label text-right">密碼</label>
                <div class="col-md-5">
                  <input type="password" class="form-control" id="php_member_password" name="php_member_password" placeholder="請在此輸入您的密碼" >
                </div>
              </div>
            </div>
            <div class="row">
              <div>
                <div id="startbt"  class="center">
                  <input id="php_confirm" type="button" class="btn btn-primary btn-small " value="登入" />
                </div>
              </div>
            </div>
            <div class="row">
