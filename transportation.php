<?php 
	...
	require_once($config['global_library'].'/_top_transportation.php');
?>
<!DOCTYPE html>
...
<?require_once($config['global_library'].'/_transportation.php');?>
				...
				<div class="container" align="center">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h1 class="panel-title">貨運方式與計價</h1>
						</div>
						<div class="panel-body">
							
							<h6 class="text-left step1subtitle">
								<img src="/images/im/flag.gif" width="13" height="13" alt="*" class="step1subtitle-img">
								<span class="step1subtitle-text">貨運方式與計價</span>
							</h6>
							<p class="text-left">1.	到本網站下單前，先加入本公司預繳會員客戶，可享有本公司專車配送服務(限客戶資料表上單一送貨地址)偏遠、離島及海外地區恕無法宅配，若須代寄帳單以外住址，須收處理費用。</p>
							<p class="text-left">2.	花東地區、澎湖、馬公或其它偏遠地區因貨運公司運送地區緣故，須另加聯運費。</p>
							<p class="text-left">3.	寄送以一樓運送為主，若指定樓層運送時，須另按照樓層及運送才積酌收費用。(本公司貨車運送，恕只送達一樓。若以貨運運送，則依新竹貨運規定辦理)。</p>
							<p class="text-left">4.	到貨時間：寄送日的隔天送達，偏遠地區或遇假日順延1日。</p>
							<p class="text-left">5.	運費價格一律依才數計算，若需假日配送須另計。</p>
							<p class="text-left">6.	才積計算說明：長x寬x高=1立方台尺=1才=10kg。(最大長×最大寬×最大高）÷ 27,000 【尺寸丈量採公分計，才數無條件進位到整數】</p>
							<p class="text-left">7.	運費計算說明：<br />
								&nbsp;&nbsp;（1）貨物兩才（20公斤）以內算一件；:超過兩才時，每才多加30元。? 
								&nbsp;&nbsp;（2）貨物不及2才時，以2才算一件收費。								
								&nbsp;&nbsp;&nbsp;&nbsp;例如：寄送一箱貨物重量為25公斤時，價格為20公斤＝2才＝1件＝100元，5公斤為多1才，加30元，總共為130元。
							</p>
