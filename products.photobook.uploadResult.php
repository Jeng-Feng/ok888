...
<? require_once($config['global_library'].'/_top_products.photobook.uploadResult.php'); ?>
<!DOCTYPE html>
...
<div id="bootstrap_content">
	<div class="container">
					...
					<div class="panel-heading">
						...
						<? endif; ?>
                            ...
                            <script type="text/javascript">
								swfobject.embedSWF(swfobjectURL, "flashContent", "520", "380", "10.0.0", false, flashvars, params, attributes);
							</script></div>
                            </div>	
                            -->
					...
					<div class="panel-body" id="order_sel_qty_content">
						...
						<div id="controlArea">
                          ...
                          <div class="row margin20">
                            <div class="col-md-12">書本上膜皆預設亮膜、其餘種類為加價選購。</div>
                             <div class="col-md-12"><a href="#">上膜效果</a></div><br><br>
                             </div>		
						</div>
		...
		<div class="row">
			...
			<div class="col-md-6 col-md-offset-6" id="order_editagain">
				<div class="panel panel-primary">
					<div class="panel-heading">
					...
					<div class="panel-body" id="order_editagain_content">
						<div>
							<div class="text-left">
								...
								<?	endif ?>
								<div class="form-group">
									編輯此頁的網址:<input class="form-control" type="text" id="editor_url" readonly value="" onclick="$(this).select();" />
								</div>	
