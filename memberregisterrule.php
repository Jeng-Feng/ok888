<?php 
	...
	require_once($config['global_library'].'/_top_memberregisterrule.php');
?>
<!DOCTYPE html>
...
<?require_once($config['global_library'].'/_memberregisterrule.php');?>
				...
				<div class="container" align="center">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<p class="text-left">「<?=$siteCompany;?>」 （以下稱本公司），係依據本服務條款提供<?=$webSiteName;?>（<?=$config["url"];?>）服務 (以下簡稱「本服務」)。當您使用本服務時，即表示您已閱讀、瞭解並同意接受本服務條款之所有內容。本公司有權於任何時間修改或變更本服務條款之內容，建議您隨時注意該等修改或變更。您於任何修改或變更後繼續使用本服務，視為您已閱讀、瞭解並同意接受該等修改或變更。如果您不同意本服務條款的內容，或者您所屬的國家或地域排除本服務條款內容之全部或一部時，您應立即停止使用本服務。<br /><br />若您為未滿二十歲，除應符合上述規定外，並應於您的家長（或監護人）閱讀、瞭解並同意本服務條款之所有內容及其後修改變更後，方得使用或繼續使用本服務。當您使用或繼續使用本服務時，即推定您的家長（或監護人）已閱讀、瞭解並同意接受本服務條款之所有內容及其後修改變更。</p>
					...
					<div class="text-center">
						...
						<span class="txtBlack" onclick="document.getElementById('igotit').checked=!document.getElementById('igotit').checked;" style="cursor:default">我已經閱讀過相關權益，且同意加入會員。 </span>
						<input class="btn btn-primary" type="button" value="取消申請" onclick="history.go(-1);" />
						<input class="btn btn-primary" type="button" id="agreebt" onclick="MM_goToURL('parent','memberregister.php');return document.MM_returnValue"  name="Submit2" value="同意確認" /><br />
					</div>
