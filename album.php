<?php 
	...
	require_once($config['global_library'].'/_top_album.php');
?>
<!DOCTYPE html>
...
<? require_once($config['global_library'].'/_album.php'); ?>
    ...
    <div class="margin-top none"> <!-- InstanceBeginEditable name="main content" -->
		...
		<?//require_once($config['global_library'].'/_albumView.php');?>
			<div id="bootstrap_content">
				<div class="container" align="center"><?require_once($config['global_library'].'/_albumView.php');?></div>
			</div>
