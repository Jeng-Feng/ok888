  ...
  <div class="container">
    <div class="row">
      ...
      <aside id="sidebar" class="col-md-3">
        <nav id="subnav">
          <ul>
            ...
            <li><a class="active" href="faq02.php">照片的準備<i class=" icon-right-open-mini"></i></a></li>
      ...
      <section class="col-md-9">
        ...
        <div class="row mb15">
          <div class="col-md-12">
            <h2>Q1：照片的解析度需要多少才夠？</h2>
            <p> A：此處所說的照片，是指利用數位相機／照相手機拍攝的檔案(<span>RGB模式、*.jpg</span>)，建議您使用手中數位攝影器材的<span>最高品質 </span>來拍攝照片。
            <span>請注意：若您要製作【無框裝飾畫、拍照背景牆】，請至少使用2000萬畫素(約5616*3744像素)的照片解析度。</span></p>
          </div>
          <div class="col-md-12"> <a href="http://www.lifebooks.com.tw//product/photobook/preview.php?sid=144KooDlZd" class="lytebox" data-lyte-options="width:90% height:90% scrollbars:no" data-title="照片解析度與實際印刷範本">點我詳閱</a> </div>
        </div>
        <div class="row mb15">
          <div class="col-md-12">
            <h2>Q2：我需要準備多少數量的照片才夠？</h2>
            <p> A：相片書→挑選產品→進入編輯→選擇風格套版，所有風格套版圖示下方都會提示可使用照片的參考數量（如下圖）。
            無框裝飾畫：每個套版僅能使用1張；拍照背景牆：多數套版僅能使用1張，部分版型可放2~5張不等。</p>
          </div>
          <div class="col-md-12"> <img src="images/faq-details/newbie_full.jpg" alt="參考數量" class="img-responsive"> </div>
        </div>
        <div class="row mb15">
          <div class="col-md-12">
            <h2>Q3：使用老照片（傳統相片）可以製作相片書嗎？</h2>
            <p> A：本系統接受匯入、上傳的照片為<span>RGB模式、300DPI、*.jpg檔</span>。
            若想使用傳統老照片的圖像製作相片書，<span>請先進行數位化處理</span>，您可透過掃描器或數位攝影器材，將圖像轉為數位檔。</p>
          </div>
        </div>
        <div class="row mb15">
          <div class="col-md-12">
            <h2>Q4：貴公司可以幫我把老照片數位化嗎？</h2>
            <p> A：很抱歉！！目前，本公司 僅承製<span>印刷及裝訂相片書的業務，沒有提供老照片數位化的服務。</span></p>
          </div>
        </div>
        <div class="row mb15">
          <div class="col-md-12">
            <h2>Q5：印製相片書，我需要將照片轉成CMYK模式嗎?</h2>
            <p> A：只要數位攝影器材拍攝出來的檔案，就可以直接編輯與印製。
              本公司採用RGB色域輸出，可保留較大的色域空間使色彩更加鮮豔。
              目前數位相機、照相手機或平版電腦等，拍攝的檔案都是RGB模式、*.jpg檔，所以<span>不需要再做色彩轉換</span>的處理。</p>
            </div>
          </div>
        </section>
