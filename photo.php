<?php 
	...
	require_once($config['global_library'].'/_top_photo.php');
?>
<!DOCTYPE html>
...
<?require_once($config['global_library'].'/_photo.php'); ?>
<script src="js/jquery.prettyPhoto.js"></script>
<script type="text/javascript" src="js/jquery.contextmenu.r2.js"></script>
<script type="text/javascript" src="Scripts/jquery.easing.1.3.js"></script>
<!-- Colorbox Libary -->
<script type="text/javascript"  src="js/colorbox/jquery.colorbox-min.js"></script>
<script type="text/javascript"  src="js/colorbox/i18n/jquery.colorbox-zh-TW.js"></script>
<link type="text/css" rel="stylesheet" href="js/colorbox/style5/colorbox.css" />
<!-- Toastmessage Libary -->
    ...
    <div class="margin-top none"> <!-- InstanceBeginEditable name="main content" -->
		...
		<?//require_once($config['global_library'].'/_albumView.php');?>
			<div id="bootstrap_content">
				<div class="container" align="center"><?require_once($config['global_library'].'/_photoView.php');?></div>
			</div>
