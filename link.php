  ...
  <section id="page">
    ...
    <div class="margin-top none"> <!-- InstanceBeginEditable name="main content" -->
		...
		<div class="container" align="center">
         <div class="link">
        <ul>
        <li><a href="#" onclick="gotoeditor_customization('photobook','a4hhp_32p');return false;"><img src="images/products/photobook0.png" /></a></li>
        <li><a href="#" onclick="gotoeditor_customization('sticker','sticker1m108pknt');return false;"><img src="images/products/sticker0.png" /></a></li>
        <li><a href="#" onclick="gotoeditor_customization('postcard','postcard.a');return false;"><img src="images/products/pic.png" /></a></li>
        <li><a href="http://photo.maxm.com.tw/customprods.php?c=c_cate_9" ><img src="images/products/paper.png" /></a></li>
        </ul>
        </div>
        </div>
