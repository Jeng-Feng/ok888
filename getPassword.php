...
<? require_once($config['global_library'].'/_top_getPassword.php'); ?>
<!DOCTYPE html>
...
<? require_once($config['global_library'].'/_getPassword.php'); ?>
<!-- InstanceEndEditable -->
</head>
<body>
<!-- Primary Page Layout 
		...
		<div id="bootstrap_content">
			<div class="container" align="center">
				...
				<div class="col-md-6 col-md-offset-3">
					<span>如果您忘記了密碼，請選擇下列方式，填寫相關訊息後我們將迅速產生新的密碼驗證碼並傳送給您，謝謝！</span><br>
				</div>
				<form class="form-horizontal" role="form" action="getPassword.php" method="post" name="form1" id="form1">
					<div class="col-md-12">
						<div id="mobile_tr1" class="panel panel-primary">
							<div class="panel-heading">
								<span>由 E-mail 取得密碼驗證碼</span>
							</div>
							<div class="panel-body">
								<div class="form-group">
									<label for="inpubktitle3" class="col-md-3 control-label">請填寫您的帳號：</label>
									<div class="col-md-9">
										<input id="useemail_account" class="form-control" name="useemail_account" type="text" size="30" onkeyup="whichButton(1,event)" placeholder="請在此輸入您的帳號"/>
									</div>
								</div>
								<div class="form-group">
									<label for="inpubktitle3" class="col-md-3 control-label">請填寫您的E-mail信箱：</label>
									<div class="col-md-9">
										<input id="useemail" class="form-control" name="useemail" type="text" size="30" onkeyup="whichButton(1,event)" placeholder="請在此輸入您的E-mail信箱"/>
									</div>
								</div>
								<div class="form-group">
									<input type="button" id="checkbutton1" class="btn btn-primary" value="取得密碼驗證碼" onclick="btnFindPassword(1);">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div id="mobile_tr3" class="panel panel-primary">
							<div class="panel-heading">
								<span>由 手機簡訊 取得密碼驗證碼</span>
							</div>
							<div class="panel-body">
								<div class="form-group">
									<label for="inpubktitle3" class="col-md-3 control-label"><span class="getpassword">您的帳號：</span></label>
									<div class="col-md-9">
										<input id="usecellphone_account" class="form-control" name="usecellphone_account" type="text" size="30" onkeyup="whichButton(2,event)" placeholder="請在此輸入您的帳號"/>
									</div>
								</div>
								<div class="form-group">
									<label for="inpubktitle3" class="col-md-3 control-label"><span class="getpassword">您的行動電話號碼：</span></label>
									<div class="col-md-9">
										<input id="usecellphone" class="form-control" name="usecellphone" type="text" size="30" onkeyup="whichButton(2,event)" placeholder="請在此輸入您的行動電話號碼"/>
									</div>
								</div>
								<div class="form-group">
									<input type="button" id="checkbutton2" class="btn btn-primary" value="取得密碼驗證碼" onclick="btnFindPassword(2);">
								</div>
							</div>
						</div>
					</div>
