<?php 
	...
	require_once($config['global_library'].'/_top_editlocked.php');
?>
<!DOCTYPE html>
...
<?require_once($config['global_library'].'/_editlocked.php');?>
			...
			<div id="bootstrap_content">
				<div class="container" align="center">
					...
					<div class="alert alert-danger" role="alert">
					  <p class="alert-link">很抱歉, 此製作目前無法編輯、訂購, 請稍候再編輯或訂購!</p>
					</div>
