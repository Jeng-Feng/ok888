...
<? require_once($config['global_library'].'/_top_products.invitationcard.php'); ?>
<!DOCTYPE html>
...
<? require_once($config['global_library'].'/_products.invitationcard.php'); ?>
			...
			<div class="row keyininfor" style="display:none">
				...
				<div class="col-md-6">
					<form class="form-horizontal" role="form"  method="post" name="gotoeditor" id="gotoeditor">
					  ...
					  <div class="form-group">
						<div id="startbt" class="col-sm-offset-2 col-sm-10">
