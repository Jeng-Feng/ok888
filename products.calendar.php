...
<? require_once($config['global_library'].'/_top_products.calendar.php'); ?>
<!DOCTYPE html>
...
<!-- InstanceBeginEditable name="custom javascript" -->
  <? require_once($config['global_library'].'/_products.calendar.php'); ?>
  <style>
  .box_heigh{
    min-height:300px;
    }
  ...
  <div class="container">
    ...
    <div class="php_productarea">
      <div class="row">
        ...
        <!--舊程式<? foreach($products_data as $data): ?>
